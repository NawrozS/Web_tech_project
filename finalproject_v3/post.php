		...
		<div class="form_div">
            ...
            <form class="quote" accept="post.php" method="post" name="myForm" onsubmit="return validateForm()" enctype="multipart/form-data" >
              ...
              <div>
                ...
                <input type="number" min="1500"   name="rnp" class="input"  placeholder="Amount">
              </div>
              <div>
              ...
              <div>
               ...
               <label>TYPE:</label>  &nbsp;
                <select name="op">
 				 ...
 				 <option value="Appartmet_For_Sell">Appartmet For Sell</option>
 				 <option value="Office">Appartmet For Sell</option>
